...
import { ArrowLeft, Calendar, MapPin, DollarSign, Globe, Image as ImageIcon, Plus } from 'lucide-react';
...
export function CreateEventPage({ onBack, onEventCreated }: CreateEventPageProps) {
  ...
  const handleImageSearch = async () => {
    ...
    try {
      const imageUrl = await unsplash_tool(formData.imageSearchQuery);
